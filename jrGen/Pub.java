...
public class Pub extends java.lang.Object {
    { JRinit(); }
    private // NUMBER 8
    Cap_ext_ closingAlarm = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create()));
    ...
    Op_ext.JRProxyOp JRget_op_test_voidTovoid()
    {
        return op_test_voidTovoid;
    }
    
    public Op_ext.JRProxyOp op_test_voidTovoid;
    class ProcOp_voidTovoid_impltest extends ProcOp_ext_impl
    {
        Pub thisarg;
        public ProcOp_voidTovoid_impltest(Pub thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                thisarg.testvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.testvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    void testvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_test_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void testvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Begin Expr2
                ...
                // Begin JRCall
                // Begin Expr2
                (new Cap_ext_(closingAlarm, "void")).call(jrvm.getTimestamp(), (java.lang.Object[]) null);// End JRCall
    ...
    Op_ext.JRProxyOp JRget_op_test2_voidTovoid()
    {
        return op_test2_voidTovoid;
    }
    
    public Op_ext.JRProxyOp op_test2_voidTovoid;
    class ProcOp_voidTovoid_impltest2 extends ProcOp_ext_impl
    {
        Pub thisarg;
        public ProcOp_voidTovoid_impltest2(Pub thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                thisarg.test2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.test2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    void test2voidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_test2_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void test2voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Receive
                {
                    jrvm.sendAndDie();
                    Recv_ext recv_voidTovoid = closingAlarm.recv();
    ...
    protected void JRinit() {
    	...
    	try {
    	op_test2_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_impltest2(this));
    	op_test_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_impltest(this));
    	} catch (Exception JRe)
    	{ throw new jrRuntimeError(JRe.toString()); }
    	jrresref = new JRPub(op_test2_voidTovoid, op_test_voidTovoid);
    	this.JRcalled = true;
    }
    ...
    private void JRprocess() {
    	...
    	JRproc = true;
    	try {
    		op_test2_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
    		op_test_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
